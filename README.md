...
![Решение лабиринта](img/solve_50_50.PNG)
...
- Автоматическая генерация идеального лабиринта (алгоритм Эллера) (не раелизован в этой версии, сделаю свою реализацию)
...
- BFS (поиск в ширину)
- Алгоритм Эллера (не раелизован в этой версии, сделаю свою реализацию)
- Makefile

## Формат файла лабиринта
Файл с лабиринтом (Maze/maze_sample):
Первая строка: количество строк и столбцов
Далее — матрица вертикальных стен
Затем — матрица горизонтальных стен
